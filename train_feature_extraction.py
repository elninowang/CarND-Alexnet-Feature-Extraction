...
labels = tf.placeholder(tf.int64, (None))        # because compare to tf.argmax,the type is tf.int64
...
equals = tf.equal(preds, labels)
accuracy_operation = tf.reduce_mean(tf.cast(equals, tf.float32))
